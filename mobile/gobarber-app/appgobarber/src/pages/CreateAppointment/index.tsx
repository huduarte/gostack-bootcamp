...
const CreateAppointment: React.FC = () => {
  ...
  const morningAvailabiity = useMemo(() => {
    return availability
      .filter(({ hour }) => hour < 12)
      .map(({ hour, available}) => {
        return {
      ...
      <Content>
        <ProvidersListContainer>
          <ProvidersList
            ...
            renderItem={({item: provider}) => (
              ...
              >
                <ProviderAvatar 
                  source={{uri: provider.avatar_url ? provider.avatar_url : 'https://premierpesa.co.ke/public/assets/img/anonymous.png'}}/>
                <ProviderName
                  selected={provider.id === selectedProvider}
                >
                  {provider.name}
        ...
        <Schedule>
          ...
          <Section>
            ...
            <SectionContent>
              {morningAvailabiity.map(({hourFormatted, hour, available }) => (
                <Hour 
                  enabled={available}
